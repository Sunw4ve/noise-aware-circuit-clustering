...
class DefParser:
    ...
    def parse(self):
        ...
        :return: void
        """
        print ("[INFO] Start parsing DEF file...")
...
if __name__ == '__main__':
    ...
    read_path = "./lef-parser/libraries/DEF/aes_cipher_top_route.def"
    ...
    for each_comp in def_parser.components.comp_dict:
        # print (each_comp)
        print (def_parser.components.comp_dict[each_comp])
        print ()
